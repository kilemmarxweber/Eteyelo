  ...
  (
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        onKeyDown={(event) => {
          // Entrée / espace sélectionnent sans pointerdown.
        ...
        onCloseAutoFocus={(event) => {
          // Le contenu portail n’est plus dans le DOM : Dialog peut croire
          // à un focus outside. On ignore le dismiss juste après la fermeture.
