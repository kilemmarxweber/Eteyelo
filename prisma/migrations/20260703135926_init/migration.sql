...
CREATE TABLE "Partnaire" (
    ...
    CONSTRAINT "Partnaire_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "StudentGrade_studentId_periodId_branchId_key" ON "StudentGrade"("studentId", "periodId", "branchId");
...
-- CreateIndex
CREATE INDEX "Partnaire_branchId_idx" ON "Partnaire"("branchId");

-- CreateIndex
CREATE INDEX "Partnaire_isActive_idx" ON "Partnaire"("isActive");

-- CreateIndex
CREATE INDEX "Partnaire_isFeatured_idx" ON "Partnaire"("isFeatured");

-- CreateIndex
CREATE INDEX "Partnaire_ville_idx" ON "Partnaire"("ville");

-- CreateIndex
CREATE INDEX "Partnaire_pays_idx" ON "Partnaire"("pays");

-- CreateIndex
CREATE UNIQUE INDEX "Partnaire_slug_key" ON "Partnaire"("slug");
...
-- AddForeignKey
ALTER TABLE "Partnaire" ADD CONSTRAINT "Partnaire_branchId_fkey" FOREIGN KEY ("branchId") REFERENCES "Branch"("id") ON DELETE SET NULL ON UPDATE CASCADE;
