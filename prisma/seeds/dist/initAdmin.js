...
exports.clearAdmin = exports.initAdmin = void 0;
var prisma_1 = require("@/lib/prisma");
function initAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var adminUser, existingAdmin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    adminUser = _a.sent();
                    if (!adminUser) {
                        console.warn("⚠️  Utilisateur admin non trouvé");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, prisma_1["default"].admin.findFirst({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma_1["default"].admin.deleteMany({})];
                case 1:
                    _a.sent();
