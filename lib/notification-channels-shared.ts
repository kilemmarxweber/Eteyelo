...
export const NOTIFICATION_EVENT_META: Array<{
  ...
  },
  {
    ...
    hint: "Caisse et nouveaux inscrits, toutes les branches, vers 17h55 — destinataires : owner/propriétaire, admin/gestionnaire et admin/propriétaire (jamais le dimanche ni un jour férié calendrier).",
  },
];
