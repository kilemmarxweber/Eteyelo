    ...
    case "ATELIER":
      return {
        ...
        sections: [
          {
            ...
            items: [
              ...
              "3. Inscrire l'eleve a un groupe atelier (classe source).",
              "4. Lier les cours atelier aux matieres secondaires, puis affecter les enseignants.",
          ...
          },
          {
            ...
            items: [
              ...
              "Pas de ponderations atelier : l'affectation suit la classe source et les liens de cours.",
              "Vacations atelier Matin (avant-midi) et Soir creees automatiquement : seance longue (360 min+), sans recreation.",
        ...
        quickLinks: [
          ...
          { label: "Affectations", href: "/admin/teaching" },
