...
function getPrismaClient() {
  ...
  const hasAttendanceFaceDescriptorDelegate =
    typeof (
      existing as { attendanceFaceDescriptor?: { findMany?: unknown } }
    )?.attendanceFaceDescriptor?.findMany === "function";
  ...
  if (
    ...
    hasAttendanceFaceDescriptorDelegate &&
