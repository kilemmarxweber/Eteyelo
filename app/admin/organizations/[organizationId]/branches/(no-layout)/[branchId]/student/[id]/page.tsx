...
const SingleStudentPage = async ({
  ...
  const profile: StudentProfileData = {
    ...
    placeOfBirth: student.placeOfBirth ?? "-",
    nationality: student.nationalite?.trim() || branch.pays || "Congolaise",
    autreNationalite: student.autreNationalite?.trim() || "-",
    ...
    nomMere: student.parent.nomMere?.trim() || "-",
    professionMere: student.parent.professionMere?.trim() || "-",
    tuteurNom: student.parent.tuteurNom?.trim() || "-",
    adresseTuteur: student.parent.adresseTuteur?.trim() || "-",
    provinceOrigine: student.parent.provinceOrigine?.trim() || "-",
    territoireOrigine: student.parent.territoireOrigine?.trim() || "-",
    secteurOrigine: student.parent.secteurOrigine?.trim() || "-",
    villageOrigine: student.parent.villageOrigine?.trim() || "-",
    canEditFamilyPersonalInfo: isParentViewer,
    parentId: student.parent.id,
    parentNom: parentUser?.name ?? "",
    parentPostnom: parentUser?.postnom ?? "",
