...
import { deleteStudentAction } from "../student.action";
    ...
    startDeleteTransition(async () => {
      for (const student of students) {
        try {
          ...
          toast.error(`Failed to delete student ${student.id}: ${err}`);
        }
      }
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            votre <span className="font-medium">{students.length}</span>
